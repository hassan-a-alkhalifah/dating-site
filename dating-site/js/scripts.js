...
// Submit form
  ...
  $("#landingPageButton").click(function() {
    ...
    function profileGen() {
      ...
      var imageMale = ["img/man1.jpg", "img/man2.jpg", "img/man3.jpg", "img/man4.jpg", "img/man5.jpg"]
                  ...
                  for (var n = 0; n < relationship.length; n++){
                    for (var o = 0; o < personality.length; o++) {
                      if (j == 1){
                        ...
                        allProfiles.push(new Profile(firstNameFemale[randInt(0, firstNameFemale.length-1)], lastName[randInt(0, lastName.length-1)], phone, age[h], height[i], gender[j], orientation[k], agePref[l], heightPref[m], relationship[n], personality[o], bio[randInt(0, bio.length-1)], imageFemale[randInt(0, imageFemale.length-1)]))
                      } else {
                        allProfiles.push(new Profile(firstNameMale[randInt(0, firstNameMale.length-1)], lastName[randInt(0, lastName.length-1)], phone, age[h], height[i], gender[j], orientation[k], agePref[l], heightPref[m], relationship[n], personality[o], bio[randInt(0, bio.length-1)], imageMale[randInt(0, imageFemale.length-1)]))
                      }
                    }
                  }
                }
